 ...
 * @method 获取相似歌单
 */
export const getSimilarPlayList = id => api.get(`/simi/playlist?id=${id}`, {})
...
export const getSongComment = params => api.get(`/comment/music`, { params })

/**
 * @method 获取相似歌曲
 */

export const getSimilarSongs = (id, params) =>
  api.get(`/simi/song?id=${id}`, { params })
...
export const getHotComment = params => api.get(`/comment/hot`, { params })

/**
 * @method 获取mv评论
 */
export const getMvComment = params => api.get('/comment/mv', { params })
